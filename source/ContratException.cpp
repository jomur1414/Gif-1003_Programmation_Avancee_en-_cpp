...
ContratException::ContratException(std::string p_fichP, unsigned int p_prmLigne,
		...
		logic_error(p_msgP), m_expression(p_exprP), m_fichier(p_fichP), m_ligne(
				p_prmLigne) {
}
/**
...
AssertionException::AssertionException(std::string p_fichP,
		unsigned int p_prmLigne, std::string p_exprP) :
 ...
 * \param p_exprP Test logique qui a échoué
 */
PreconditionException::PreconditionException(std::string p_fichP,
		unsigned int p_prmLigne, std::string p_exprP) :
 ...
 * \param p_exprP Test logique qui a échoué
 */
PostconditionException::PostconditionException(std::string p_fichP,
		unsigned int p_prmLigne, std::string p_exprP) :
		ContratException(p_fichP, p_prmLigne, p_exprP,
 ...
 * \param p_exprP Test logique qui a échoué
 */
InvariantException::InvariantException(std::string p_fichP,
		unsigned int p_prmLigne, std::string p_exprP) :
